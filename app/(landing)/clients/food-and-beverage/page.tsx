...
export const metadata: Metadata = {
  title: 'Food & Beverage Security Services | Optimus',
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="mb-12 flex items-center gap-4">
        ...
        <h1 className="text-4xl font-bold">Food & Beverage Security</h1>
      </div>

      {/* Description */}
      <div className="mb-12">
        <p className="mb-6 text-xl text-muted-foreground">Reliable security for food and beverage establishments.</p>
        <div className="prose dark:prose-invert max-w-none">
          <p>
            Our food & beverage security services are designed to provide comprehensive protection tailored specifically
            for the food & beverage sector. We understand the unique security challenges faced by food & beverage
