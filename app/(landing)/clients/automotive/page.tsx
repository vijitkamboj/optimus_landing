...
export const metadata: Metadata = {
  title: 'Automotive Security Services | Optimus',
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="mb-12 flex items-center gap-4">
        ...
        <h1 className="text-4xl font-bold">Automotive Security</h1>
      </div>

      {/* Description */}
      <div className="mb-12">
        <p className="mb-6 text-xl text-muted-foreground">Comprehensive security for the automotive industry.</p>
        <div className="prose dark:prose-invert max-w-none">
          <p>
            Our automotive security services are designed to provide comprehensive protection tailored specifically for
            the automotive sector. We understand the unique security challenges faced by automotive establishments and
