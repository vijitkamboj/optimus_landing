...
export const metadata: Metadata = {
  title: 'Health Care Security Services | Optimus',
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      ...
      <div className="mb-12 flex items-center gap-4">
        ...
        <h1 className="text-4xl font-bold">Health Care Security</h1>
      </div>

      {/* Description */}
      <div className="mb-12">
        <p className="mb-6 text-xl text-muted-foreground">Specialized security for hospitals and clinics.</p>
        <div className="prose dark:prose-invert max-w-none">
          <p>
            Our health care security services are designed to provide comprehensive protection tailored specifically for
            the health care sector. We understand the unique security challenges faced by health care establishments and
