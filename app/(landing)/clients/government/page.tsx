...
export const metadata: Metadata = {
  title: 'Government Security Services | Optimus',
...
export default function GovernmentPage() {
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      {/* Hero Section */}
      <div className="items-cen ter mb-12 flex gap-4">
        <div className="rounded-lg bg-muted p-3">
          <Landmark className="h-8 w-8 text-primary" />
        </div>
        <h1 className="text-4xl font-bold">Government Security</h1>
      </div>

      {/* Description */}
      <div className="mb-12">
        <p className="mb-6 text-xl text-muted-foreground">Trusted security services for government entities.</p>
        <div className="prose dark:prose-invert max-w-none">
          <p>
            Our government security services are designed to provide comprehensive protection tailored specifically for
            the government sector. We understand the unique security challenges faced by government establishments and
