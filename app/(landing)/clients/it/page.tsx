...
export const metadata: Metadata = {
  title: 'IT Security Services | Optimus',
...
export default function ITPage() {
  ...
  return (
    <main className="container mx-auto px-4 py-8">
      ...
      {/* Description */}
      <div className="mb-12">
        <p className="mb-6 text-xl text-muted-foreground">Safeguarding IT companies and data centers.</p>
        <div className="prose dark:prose-invert max-w-none">
          <p>
            Our it security services are designed to provide comprehensive protection tailored specifically for the it
            sector. We understand the unique security challenges faced by it establishments and offer specialized
